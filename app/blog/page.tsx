...
import ListItem from "@/app/components/utils/ListItem";


function BlogPage() {

    return (
        <main className="min-h-[calc(100vh-81px)] bg-zinc-50 px-6 py-12 text-zinc-900 sm:px-10 1g:px-16 lg:py-20">
            <div className="mx-auto max-w-6xl"> 
                <div className="grid gap-10 border-b border-emerald-900/15 pb-12 lg:grid-cols-[1.4fr_0.6fr] 1g:items-end 1g:pb-16"> 
                    <div>
                        <p className="mb-5 text-sm font-bold tracking-[0.16em] text-emerald-700">BLOG ACADEMICO</p> 
                        <h1 className="max-w-4xl text-4x1 font-bold tracking-tight text-emerald-950 sm:text-5x1 1g:text-6x1"> 
                ...
                <section className="pt-10 lg:pt-14" aria-labelledby="explora-el-blog">
                    <div className="mb-6 flex items-center justify-between gap-4">
                        <h2 id="explora-el-blog" className="text-xl font-semibold text-emerald-950 sm:text-2x1">Explora el blog</h2> 

...
export const blogPosts: Record<string, BlogPost> = {
  ...
  "areas-de-formacion": {
    ...
    paragraph: [
      "La formación en tecnologías de la información reúne conocimientos de desarrollo de software, redes, datos, ciberseguridad e innovación. Cada área aporta herramientas para compren der, transforma",
  ...
  "historias-que-inspiran": {
    ...
    paragraph: [
      "Los proyectos y experiencias de nuestra comunidad muestran que las ideas crecen cuando se comparten. Cada reto superado deja aprendizajes que pueden inspirar a otras personas a continuar.",
